...
//  my::unique_ptr<int[]> tbl1 {new int[3] {1,2,3}};
//  tbl1[1] = 123;
//
//  my::unique_ptr<int[]> tbl2 {my::make_unique<int[]>(3)};
//  tbl2[1] = 123;
//
//  std::cout << "-----------------" << std::endl;
//
  my::unique_ptr<int, Deleter> p1 {new int {34543}};
  ...
  *p1 = 666;
  ...
  my::unique_ptr<int, Deleter> p2 {new int {121212}};
...
//  delete rawPtr;
  ...
  my::unique_ptr<int, Deleter> p3 {new int {56789}};
  ...
  my::unique_ptr<int, Deleter> p4 {new int {111}};
  my::unique_ptr<int, Deleter> p5 {new int {222}};
  p4.swap(p5);
  ...
  auto p6 {my::make_unique<int>(123)};
//  p6.reset();
  if(p6)
