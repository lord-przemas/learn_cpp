...
int main()
{
  ...
  std::shared_ptr<int> p1 {new int {34543}, Deleter{}};
  ...
  *p1 = 666;
  ...
  std::shared_ptr<int> p2 {new int {121212}};
  std::cout << "p2 value: " << *p2 << std::endl;
  std::cout << "p2 value: " << *rawPtr << std::endl;

  std::cout << "-----------------" << std::endl;

  std::shared_ptr<int> p3 {new int {56789}};
  ...
  std::shared_ptr<int> p4 {new int {111}};
  std::shared_ptr<int> p5 {new int {222}};
  p4.swap(p5);
  ...
  auto p6 {std::make_shared<int>(123)};
//  p6.reset();
  if(p6)
  ...
  std::shared_ptr<int> sharedPtr1 {iptr};
  std::cout << "sharedPtr1.use_count: " << sharedPtr1.use_count() << std::endl;
//  std::shared_ptr<int> sharedPtr2 {iptr}; // Don't do it! It' terated as another pointer
  ...
  std::shared_ptr<int> sharedPtr4 {sharedPtr2};
  std::cout << "sharedPtr4.use_count: " << sharedPtr4.use_count() << std::endl;
  std::shared_ptr<int> sharedPtr5 {std::move(sharedPtr1)};
  std::cout << "sharedPtr5.use_count: " << sharedPtr5.use_count() << std::endl;
  std::shared_ptr<int> sharedPtr6 {std::move(sharedPtr2)};
  std::cout << "sharedPtr6.use_count: " << sharedPtr6.use_count() << std::endl;
  std::shared_ptr<int> sharedPtr7 {sharedPtr3};
